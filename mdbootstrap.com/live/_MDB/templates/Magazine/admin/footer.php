<footer class="page-footer center-on-small-only">
                ...
                <div class="col-xl-5 col-lg-6">
					...
					<div class="footer-imgs">
						<ul class="instagram-photos">
							...
							<li>
								<div class="view overlay hm-white-slight">
									<img class="img-fluid" src="../../../../../img/Photos/Avatars/img%20(6).jpg" alt="Instagram photo cap">
									<a href="#!">
										<div class="mask  waves-light"></div>
									</a>
								</div>
							...
							<li>
								<div class="view overlay hm-white-slight">
									<img class="img-fluid" src="../../../../img/Photos/Avatars/img%20(3).jpg" alt="Instagram photo cap">
									<a href="#!">
										<div class="mask  waves-light"></div>
									</a>
								</div>
							...
							<div class="hidden-down no-height"><br></div>
        ...
        <div class="social-section wow fadeIn" data-wow-delay="0.3s">
            <ul>
                ...
                <li><a class="btn-floating btn-small btn-dribbble waves-effect waves-light"><i class="fa fa-dribbble"> </i></a></li>
        ...
        <div class="footer-copyright wow fadeIn" data-wow-delay="0.3s">
            <div class="container-fluid">
                © 2015 - 2016 Copyright: <a href="http://www.mdbootstrap.com/"> MDBootstrap.com </a>
            </div>
        </div>
        <!--/ Copyright -->
